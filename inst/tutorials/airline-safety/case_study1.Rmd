...
For this case study, we load the following packages:



```{r setup-airlines, include=TRUE}
library(ggplot2)
library(haven)
library(dplyr)
```
...
if (!require("ScPoApps")){
  data=read.csv(file = "https://raw.githubusercontent.com/ScPoEcon/ScPoApps/master/inst/datasets/airline-safety.csv")
} else {
    data=read.csv(system.file(package = "ScPoApps", "datasets", "airline-safety.csv"))
}
